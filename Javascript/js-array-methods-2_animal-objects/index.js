...
console.log("First Animal starting with G: " , firstAnimalStartingWithLetterG);

const indexOfAnimalWithNameLongerFive = animals.findIndex(animal => animal.name.length > 5);
console.log("Index of animal with name longer than 5: " , indexOfAnimalWithNameLongerFive);
